...
exports.getTeamOffensiveTendencies = getTeamOffensiveTendencies;
exports.getTeamDefensiveStyle = getTeamDefensiveStyle;
function getTeamOffensiveTendencies(team) {
...
function getTeamDefensiveStyle(team) {
    const players = team.players;
    if (players.length === 0)
        return 'balanced';
    ...
    if (avgInterior > avgPerimeter + 8)
        return 'paint-protection';
    if (avgPerimeter > avgInterior + 8)
        return 'perimeter-focused';
    return 'balanced';
}
//# sourceMappingURL=playStyle.js.map